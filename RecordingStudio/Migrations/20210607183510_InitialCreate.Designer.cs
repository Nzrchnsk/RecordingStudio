...
namespace RecordingStudio.Migrations
{
    ...
    [Migration("20210607183510_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecordingStudio.Models.Price", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<double>("CostPerHours")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("RecordingStudio.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RecordingStudio.Models.Order", b =>
                {
                    b.HasOne("RecordingStudio.Models.Price", "Price")
                        .WithMany("Orders")
